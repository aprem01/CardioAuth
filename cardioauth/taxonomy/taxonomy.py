...
CRITERION_TAXONOMY: dict[str, Criterion] = {
    ...
    "SX-004": Criterion(
        ...
        definition="Functional class documented using validated scale (NYHA for HF, CCS for angina, EHRA for AF symptoms).",
        evidence_type="score",
        applies_to=["33361", "93656", "93458"],
    ...
    "DOC-001": Criterion(
        code="DOC-001",
        category="DOC",
        short_name="Cardiology consultation note attached",
        definition="Recent cardiology consultation note included with the request, documenting indication, history, and clinical rationale.",
        evidence_type="clinical_note",
